...
<template>
    ...
    <div class="container">
        <div class="form-section">
            ...
            <button class="theme-button" :style="{'background-color': bgColor, 'color': textColor}" @click = "changeTheme()">Cycle theme</button> <!-- click button to cycle through the themes -->
